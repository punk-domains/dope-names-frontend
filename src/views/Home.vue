<template>
  <div class="container text-center">
    <img class="img-fluid main-img rounded mb-5" src="../assets/dopewars-nobg.png" />

    <div class="text-align-header mt-4 mb-2">
      <h3>Secure your <span class="domain-black-bg">{{getTldName}}</span> domain.</h3>
      <p class="punchline">
        Pay once. Flex forever.
      </p>
    </div>
    ...
    <div class="d-flex justify-content-center domain-input-container mb-3 mt-5">
      <div class="input-group domain-input input-group-lg input-sizing">
        <input
          ...
          type="text" 
          class="form-control text-end border-light rounded-0 form-control-domain"
          aria-label="Text input with dropdown button"
        >

        <span class="input-group-text tld-addon rounded-0 border-0">
    ...
    <div class="row mt-5">
      <div class="col-md-6 offset-md-3 table-container">
        <table class="table table-borderless table-hover table-ppl">
